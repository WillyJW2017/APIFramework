...
class GetData:
    ...
    def get_request_data(self, row):
        col = data.dataConfig.get_request_data()
    ...
    def get_data_for_json(self, row):
        data = self.oper_json.get_data(self.get_request_data(row))
        return data

    # 获取excel里面ExpectedData列的数据
    def get_expect_data(self, row):
        col = data.dataConfig.get_expect_data()
